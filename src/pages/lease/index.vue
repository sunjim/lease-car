							...
							<view class="product" v-for="(product, key) in category.products" :key="key"
								...
								<view class="content">
									...
									<view class="price">
										...
										<actions :materials-btn="!product.is_single" @materials="showProductDetailModal(product)"
	...
	export default {
		...
		data() {
			return {
				...
				currentCategoryId: 0,
				notices: [
					{image:'https://go.cdn.heytea.com/storage/ad/2020/05/28/752a5519e89541bd8417614c599cf8c3.jpg',content:'最新公告'}
				],
				ads1: [
